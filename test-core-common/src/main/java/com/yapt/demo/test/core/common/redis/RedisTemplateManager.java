...
import com.yapt.demo.test.core.common.constant.RedisCacheTime;
...
/**
 * @author hurui
 * @version Id: RedisTemplate.java, v 0.1 2020/1/22 14:29 YaphetS Exp $$
 */
@Component
public class RedisTemplateManager {
    ...
    public boolean set(String key, Object value, long time,TimeUnit timeUnit) {
        try {
            if (time == RedisCacheTime.CACHE_EXP_FOREVER) {
